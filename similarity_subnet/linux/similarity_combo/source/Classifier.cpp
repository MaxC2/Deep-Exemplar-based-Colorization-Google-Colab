...
Classifier::Classifier(const string& model_file,
	...
	net_ = new caffe::Net<float>(model_file, TEST);
...
void Classifier::Predict(const cv::Mat& img, std::vector<std::string>& layers, std::vector<float *>& data_d, std::vector<Dim>& size) {
