...
nvcc $CUDA $SOURCE/*.cu $SOURCE/*.cpp -I/caffe/include -I/caffe/build/src -L/caffe/build/lib -o demo/bin/similarity_combo -std=c++11 \
...
nvcc $CUDA $SOURCE/*.cu $SOURCE/*.cpp -I/caffe/include -I/caffe/build/src -L/caffe/build/lib -o demo/bin/deep_image_analogy -std=c++11 \
    -I/usr/include/eigen3 -lopencv_core -lopencv_highgui -lopencv_imgproc \
    -lopencv_imgcodecs -lboost_system -lboost_filesystem -lcublas -lcaffe -lglog
